...
void Mirobot::forward_nb(int distance){
...
void Mirobot::back_nb(int distance){
...
void Mirobot::right_nb(int angle){
...
void Mirobot::left_nb(int angle){
...
void Mirobot::collideHandler(){
  ...
  //collision(collideLeft, collideRight);
